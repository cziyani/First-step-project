...
#Froh plot :
setwd("C:/Users/chaym/Desktop/FSP/firststep/RzooROH/Nouveau dossier/")
...
##have the plot on the same row in different columns
par(mfrow=c(1,3))
## loop through RAD_FRAG levels
for (i in levels(df$RAD_Frag)){
  ##List all the var and store them in one list
